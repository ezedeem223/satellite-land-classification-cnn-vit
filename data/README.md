...
This project uses the public `images-dataSAT.tar` archive referenced throughout the archived development notebooks:
...
- Earlier notebook runs extracted the archive beside the notebook files; this repository standardizes that location.
...
- The archived experiments cover multiple loading strategies:
